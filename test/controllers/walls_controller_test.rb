...
class WallsControllerTest < ActionController::TestCase
  ...
  test "should create wall" do
    assert_difference('Wall.count') do
      post :create, wall: { background: @wall.background, description: @wall.description, name: @wall.name }
    end
  ...
  test "should update wall" do
    patch :update, id: @wall, wall: { background: @wall.background, description: @wall.description, name: @wall.name }
    assert_redirected_to wall_path(assigns(:wall))
  end
